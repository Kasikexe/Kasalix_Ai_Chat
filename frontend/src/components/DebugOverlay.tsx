...
export function DebugOverlay() {
 ...
 className="fixed bottom-4 right-4 z-50 w-10 h-10 rounded-full bg-gray-800 border border-gray-700 text-gray-400 hover:text-white flex items-center justify-center"
 title="Debug"
 >
 <Bug size={18} />
 </button>
 ...
 return (
 <div className="fixed bottom-4 right-4 z-50 w-80 max-w-[calc(100vw-2rem)] bg-gray-900 border border-gray-700 rounded-lg text-xs">
 ...
 {info ? (
 <>
 <div className="text-[#4a9988] break-all">
 ...
 <div className="text-[#c44]">No profile (not logged in)</div>
 )}
 </div>
