...
export function Header({
 ...
 return (
 <>
 <header className="border-b border-gray-800 bg-gray-900/80 sticky top-0 z-20">
 ...
 {exportOpen && (
 <div className="absolute right-0 top-full mt-1 w-44 bg-gray-900 border border-gray-700 rounded-lg py-1 z-50">
 <button
 ...
 <a
 href="/download"
 className="hidden md:flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-xs font-medium transition-colors bg-blue-900/30 text-[#9bb8d6] border border-[#2a3a52] hover:bg-blue-800/40"
 ...
 {feedbackOpen && (
 <div className="absolute right-0 top-full mt-1 w-60 bg-gray-900 border border-gray-700 rounded-lg py-1.5 z-50">
 <button
 ...
 <Bug size={14} className="text-[#c44] flex-shrink-0"/>
 Report a bug
 </span>
 ...
 >
 <span className="flex items-center gap-2 text-xs text-gray-300">
 <Lightbulb size={14} className="text-[#b8966a] flex-shrink-0"/>
 Suggest an idea
 </span>
 <span className="block ml-6 mt-0.5 text-[10px] text-gray-600 group-hover:text-gray-500">
 ...
 className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-xs font-medium transition-colors bg-amber-900/30 text-[#d4b68a] border border-[#5a4a30] hover:bg-amber-800/40"
 ...
 {moreOpen && (
 <div className="absolute right-0 top-full mt-1 w-56 bg-gray-900 border border-gray-700 rounded-lg py-1.5 z-50 max-h-[70vh] overflow-y-auto">
 {conversation && conversation.messages.length > 0 && (
 <>
 <button
 ...
 >
 <Smartphone size={14} className="text-[#7b9fc6] flex-shrink-0"/>
 Download apps
 </a>
 <button
 ...
 className="flex items-center gap-2 w-full text-left px-3 py-2 hover:bg-gray-800 transition-colors text-xs text-gray-300"
 >
 <BarChart3 size={14} className="text-[#7b9fc6] flex-shrink-0"/>
 Community Poll
 </button>
 <button
