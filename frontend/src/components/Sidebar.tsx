...
export function Sidebar({
 ...
 mode === 'chat'
 ? 'bg-[#2a3a52] text-white shadow-sm'
 ...
 <Wrench size={14} />
 Koding
 <span className="absolute -top-1.5 -right-1.5 px-1 py-0.5 text-[8px] font-bold bg-[#b8966a] text-black rounded-sm leading-none shadow-sm">
 BETA
 </span>
 </button>
 </div>
 ...
 <FolderOpen size={14} className="text-[#7b9fc6] flex-shrink-0"/>
 ...
 <Wrench size={12} className="flex-shrink-0 text-[#7b9fc6]"/>
 <div
 ...
 {matchCount > 0 && (
 <span className="text-xs text-[#b8966a]/70 flex-shrink-0 mr-1">
 {matchCount}
 </span>
 )}
 ...
 className="p-0.5 hover:bg-gray-700 rounded text-[#c44]"
 aria-label="Delete"
 >
 <Trash2 size={10} />
 </button>
 ...
 <span className={`font-medium ${contentMatch.role === 'You' ? 'text-[#7b9fc6]' : 'text-green-400'}`}>
 {contentMatch.role}
 </span>
 ...
 className="p-1 hover:bg-gray-700 rounded text-[#c44]"
 aria-label="Delete"
 >
 <Trash2 size={12} />
 </button>
