...
export function FilePreview({ filePath, fileName, workspacePath, onClose, onSave }: Props) {
 ...
 <FileCode size={14} className="text-[#7b9fc6] flex-shrink-0"/>
 <span className="text-sm text-gray-200 font-medium truncate">{fileName}</span>
 <span className="text-[10px] text-gray-600 flex-shrink-0">
 {data && formatSize(data.size)}
 </span>
 {data?.truncated && (
 <span className="text-[10px] text-[#b8966a] flex items-center gap-1 flex-shrink-0">
 ...
 <AlertTriangle size={20} className="text-[#c44] mb-2"/>
 ...
 className="flex items-center gap-1.5 px-3 py-1.5 bg-[#2a3a52] hover:bg-blue-700 disabled:bg-gray-700 disabled:text-gray-500 text-white text-xs font-medium rounded-lg transition-colors"
 >
 Review changes
 </button>
 <button
