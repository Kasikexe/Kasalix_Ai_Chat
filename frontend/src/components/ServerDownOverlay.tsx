...
export function ServerDownOverlay({ isElectron, onConfigure, onBrowseFolder }: ServerDownOverlayProps) {
 ...
 <div className="pointer-events-auto max-w-xl w-full bg-gray-900 border border-[#2a3a52] rounded-lg overflow-hidden animate-fade-in">
 {/* Bar */}
 ...
 className="px-3 py-1.5 bg-amber-600/20 hover:bg-amber-600/30 border border-amber-700/40 text-[#d4b68a] text-xs font-medium rounded-lg transition-all active:scale-95"
 >
 Open Folder
 </button>
 )}
 ...
 className="px-3 py-1.5 bg-[#2a3a52] hover:bg-[#345070] text-white text-xs font-medium rounded-lg transition-all active:scale-95"
 >
 Retry
 </button>
 {onConfigure && (
 ...
 {/* Shimmer bottom edge */}
 <div className="h-0.5 via-purple-500/50 "/>
 </div>
 </div>
 );
}
