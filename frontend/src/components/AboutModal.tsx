...
export function AboutModal({ open, onClose }: Props) {
 ...
 >
 <div className="w-full max-w-2xl max-h-[88vh] flex flex-col bg-gray-900 border border-gray-800 rounded-lg animate-fade-in">
 {/* Header */}
 ...
 <Info size={20} className="text-[#7b9fc6]"/>
 </div>
 <div>
 ...
 <div className="w-14 h-14 rounded-lg bg-[#2a3a52] flex items-center justify-center text-white text-2xl font-bold shrink-0">
 ...
 {info?.version && (
 <span className="text-xs px-2 py-0.5 bg-blue-900/40 text-[#9bb8d6] border border-blue-800 rounded-full">
 v{info.version}
 </span>
 )}
 <span className="text-xs px-2 py-0.5 bg-emerald-900/40 text-[#6ab5a5] border border-emerald-800 rounded-full flex items-center gap-1">
 <Scale size={10} />
 ...
 <BookOpen size={15} className="text-[#7b9fc6]"/>
