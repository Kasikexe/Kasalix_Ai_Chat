...
export class ErrorBoundary extends Component<Props, State> {
 ...
 <div className="w-12 h-12 mx-auto rounded-xl bg-red-900/30 border border-[#5a3030] flex items-center justify-center mb-3">
 <AlertTriangle size={24} className="text-[#c44]"/>
 </div>
