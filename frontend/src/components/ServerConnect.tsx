...
export function ServerConnect({ onConnected }: ServerConnectProps) {
 ...
 <div className="inline-flex items-center justify-center w-16 h-16 rounded-lg bg-[#2a3a52] mb-4">
 ...
 {/* Connection Card */}
 <div className="bg-gray-900/80 rounded-lg border border-gray-800 p-6 space-y-5">
 ...
 protocol === 'http'
 ? 'bg-purple-600/30 border-purple-500/60 text-[#9bb8d6]'
 ...
 className="w-full flex items-center justify-center gap-2 bg-[#2a3a52] hover:bg-[#345070] disabled:bg-gray-700 disabled:text-gray-500 text-white font-medium rounded-xl py-3 transition-all duration-200 active:scale-[0.98] disabled:active:scale-100"
 >
 {testing ? (
 <>
 ...
 <XCircle className="w-4 h-4 text-[#c44] mt-0.5 shrink-0"/>
 <div className="text-sm text-[#d66] whitespace-pre-line">{errorMsg}</div>
 </div>
 )}
 ...
 className="inline-flex items-center gap-1.5 text-sm font-medium text-[#7b9fc6] hover:text-[#9bb8d6] transition-colors"
 >
 <Settings size={14} />
 Server settings
 </button>
 ...
 <p className="text-xs text-gray-500">Press Win+R → type <code className="text-[#7b9fc6] bg-gray-800 px-1 rounded">cmd</code> → Enter</p>
 <p><span className="text-gray-300 font-medium">2.</span> Run this command:</p>
 <code className="block text-[#7b9fc6] bg-gray-800 px-3 py-1.5 rounded-lg text-xs mt-1">ipconfig</code>
 <p><span className="text-gray-300 font-medium">3.</span> Look for <span className="text-[#7b9fc6]">IPv4 Address</span> under your active network adapter</p>
