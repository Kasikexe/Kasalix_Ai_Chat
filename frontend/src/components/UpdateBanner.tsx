...
export function UpdateBanner() {
 ...
 isCritical
 ? 'bg-[#1a0e0e] border-[#5a3030] '
 : 'bg-[#0e1e1a] border-[#1a3a33] '
 }`}>
 <div className={`p-1.5 rounded-lg flex-shrink-0 ${isCritical ? 'bg-red-500/20' : 'bg-emerald-500/20'}`}>
 {isCritical ? (
 <AlertTriangle size={20} className="text-[#c44]"/>
 ) : (
 <ArrowUpCircle size={20} className="text-[#4a9988]"/>
 )}
 </div>
 ...
 isCritical ? 'text-[#d66]/80 hover:text-red-200' : 'text-[#6ab5a5]/80 hover:text-emerald-200'
 }`}
 >
 ...
 className={`mt-2 max-h-48 overflow-y-auto rounded-lg border p-3 bg-black/20 ${isCritical ? 'border-[#5a3030]' : 'border-[#1a3a33]'}`}
 >
 ...
 className={`mt-2 text-[10px] underline transition-colors ${isCritical ? 'text-[#d66]/70 hover:text-red-200' : 'text-[#6ab5a5]/70 hover:text-emerald-200'}`}
 >
 ...
 isCritical ? 'hover:bg-red-800/50 text-[#d66]/50 hover:text-[#d66]' : 'hover:bg-emerald-800/50 text-[#6ab5a5]/50 hover:text-[#6ab5a5]'
 }`}
 title="Dismiss"
 >
 <X size={16} />
 ...
 <div className="mx-auto max-w-2xl mt-2 px-4">
 <div className="bg-[#0e1a28] border border-[#2a3a52] rounded-xl p-3 flex items-center gap-3">
 <div className="p-1.5 bg-blue-500/20 rounded-lg flex-shrink-0">
 <RefreshCw size={20} className="text-[#7b9fc6] animate-spin"/>
 </div>
 <div className="flex-1 min-w-0">
 ...
 <div
 className="h-full bg-[#345070] rounded-full transition-all duration-300"
 style={{ width: `${state.percent}%` }}
 />
 </div>
 </div>
 <span className="text-xs text-[#9bb8d6]/70 font-mono flex-shrink-0">
 {state.percent}%
 </span>
 </div>
 </div>
 ...
 <div className="mx-auto max-w-2xl mt-2 px-4">
 <div className="bg-[#0e1e1a] border border-[#1a3a33] rounded-xl p-3 flex items-center gap-3">
 <div className="p-1.5 bg-emerald-500/20 rounded-lg flex-shrink-0">
 <CheckCircle size={20} className="text-[#4a9988]"/>
 </div>
 <div className="flex-1 min-w-0">
 ...
 {state.status === 'error' && (
 <div className="mx-auto max-w-2xl mt-2 px-4">
 <div className="bg-[#1a0e0e] border border-[#5a3030] rounded-xl p-3 flex items-center gap-3">
 <div className="p-1.5 bg-red-500/20 rounded-lg flex-shrink-0">
 <AlertCircle size={20} className="text-[#c44]"/>
 </div>
 <div className="flex-1 min-w-0">
 <p className="text-sm font-medium text-red-200">Update failed</p>
 <p className="text-[11px] text-[#c44]/70 mt-0.5 truncate">
 {state.message}
 </p>
 </div>
 <button
