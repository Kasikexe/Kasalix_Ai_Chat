...
export function PollModal({ open, onClose }: Props) {
 ...
 >
 <div className="w-full max-w-md max-h-[88vh] flex flex-col bg-gray-900 border border-gray-800 rounded-lg animate-fade-in">
 {/* Header */}
 ...
 <BarChart3 size={20} className="text-[#7b9fc6]"/>
 </div>
 <div>
 ...
 <span className="flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[10px] font-medium bg-emerald-900/30 text-[#6ab5a5] border border-emerald-800/60 shrink-0">
 ...
 {error && !hasVoted && <p className="text-xs text-[#c44]">{error}</p>}
 ...
 <span className="mt-0.5 shrink-0 inline-flex items-center rounded-md border border-gray-700 px-2.5 py-1 text-xs font-medium text-gray-400 transition-colors group-hover:border-blue-700/60 group-hover:text-[#9bb8d6]">
 Vote
 </span>
 </div>
 </button>
 ...
 className="inline-flex items-center gap-1 text-xs text-[#7b9fc6] hover:text-[#9bb8d6] transition-colors"
 >
