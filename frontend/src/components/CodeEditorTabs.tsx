...
export function CodeEditorTabs({ files, activeFile, workspacePath, onFileSelect, onFileClose, onFileContentChange, onFileSave, onReloadFromDisk, onKeepChanges }: Props) {
 ...
 className="px-2 py-0.5 bg-[#2a3a52] hover:bg-[#345070] text-white text-[10px] font-medium rounded-lg transition-colors"
 ...
 <AlertTriangle size={12} className="text-[#b8966a]"/>
 <span className="text-xs text-[#d4b68a]/80 flex-1">Unsaved changes</span>
 <button
