...
export function AgentWorkspace({ conversation, offlineWorkspace, onCreateNew, model, thinkingEnabled = false, onMessageSent, onConversationCreated, onConversationStarted, onForkConversation }: Props) {
 ...
 {/* Tool approval modal — the agent wants to execute a mutating tool */}
 {pendingApproval && (
 <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70"
 ...
 className="flex items-center gap-2 px-5 py-2 bg-[#5a3030] hover:bg-[#6a4040] text-white text-sm font-medium rounded-xl transition-all"
 >
