...
export function ChatWindow({ messages, isStreaming, currentStage, liveDuration, liveTps, onEdit, onDelete, onRegenerate, onApplyCode, onApplyEdit, onApplyAll, onDeleteFile, searchQuery, onSearchQueryChange, searchMatches, activeSearchMatch, onSearchNext, onSearchPrev, selectedIndices, onToggleSelect, selectable, onFork }: Props) {
 ...
 <div className="sticky top-0 z-20 px-3 pt-2 pb-1.5 bg-gray-950/90 border-b border-gray-800">
 ...
 className="fixed bottom-24 right-8 z-20 w-10 h-10 bg-[#2a3a52] hover:bg-[#345070] text-white rounded-full flex items-center justify-center transition-all duration-200 hover:scale-110 active:scale-95"
 ...
 <div className="sticky bottom-0 z-20 px-4 py-2 bg-red-950/80 border-t border-[#5a3030] flex items-center justify-between">
 <span className="text-xs text-[#d66]">
 ...
 <div className="w-16 h-16 rounded-lg bg-[#1a3a33] flex items-center justify-center mb-4">
 ...
 isActiveMatch ? 'bg-[#0e1a28] border-y border-blue-700/30 -mx-2 px-2' : ''
