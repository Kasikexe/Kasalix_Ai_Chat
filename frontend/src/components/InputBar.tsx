...
export function InputBar({ onSend, onStop, isStreaming, disabled, planningEnabled, onPlanningToggle, planMode, onPlanModeChange, toolPermission, onToolPermissionChange, draftKey }: Props) {
 ...
 <div className="relative flex items-end gap-2 bg-gray-800 border border-gray-700 rounded-lg p-2 focus-within:border-gray-600 transition-colors">
 <input
 ref={fileRef}
 type="file"
 accept="image/*"
 ...
 className="flex-shrink-0 p-2 bg-[#2a3a52] hover:bg-blue-700 disabled:bg-gray-700 text-white rounded-lg"
 >
 <Send size={18} />
 </button>
 )}
