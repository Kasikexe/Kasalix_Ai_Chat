...
function getToastStyles(type: ToastType): string {
 ...
 return 'bg-[#0e1a28] border-blue-700/60 text-blue-200';
}
...
export function ToastProvider({ children }: { children: ReactNode }) {
 ...
 <div
 key={t.id}
 className={'pointer-events-auto animate-toast-slide-in flex items-center gap-3 px-4 py-3 rounded-xl border ' + getToastStyles(t.type)}
 >
